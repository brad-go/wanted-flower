...
export const NAV_BTN_COLOR = {
  CURRENT: '#F5CA5F',
  OTHER: '#E4E4E4',
};

export const TRANSTION_CONDITION = '0.5s ease-out';

export const MORE = '더보기';
export const BANNER_TITLE = '꾸까 브랜드 스토리';
